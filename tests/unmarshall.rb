...
#p DBus::Message.new.unmarshall(tests)
#
...
tests = "l\1\1\1\4\0\0\0\21\0\0\0\217\0\0\0\1\1o\0\33\0\0\0/org/gnome/Rhythmbox/Player\0\0\0\0\0\6\1s\0\23\0\0\0org.gnome.Rhythmbox\0\0\0\0\0\2\1s\0\32\0\0\0org.gnome.Rhythmbox.Player\0\0\0\0\0\0\3\1s\0\t\0\0\0playPause\0\0\0\0\0\0\0\10\1g\0\1b\0\0" + "\0\0\0\0"
p DBus::PacketUnmarshaller.new(tests, DBus::LIL_END).unmarshall(testsig)
p DBus::Message.new.unmarshall(tests)
